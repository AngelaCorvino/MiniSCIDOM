...
ax2.set_ylim([0,20])
ax.set_xlabel("Depth in PVT[mm]", fontsize=22)
# set y-axis label
ax.set_ylabel(" Relative Dose", fontsize=22)
ax2.set_ylabel("LET in KeV/µm", color=sns.color_palette("Paired")[4], fontsize=22)
ax.legend(title="", fontsize=20, loc=1, markerscale=2).set_zorder(4)
ax2.legend(title="", fontsize=20, loc=5, markerscale=2)
