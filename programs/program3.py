...
for i in range(np.shape(rec_light_dist)[0]): #from 0 to 158
    matrix_3D_corrected[i,:,:]=np.divide(                   rec_light_dist[i,:,:],
...
#Tomograpic_viewer(matrix_3D_corrected,False,0.834) # here you can enable the logaritmic scale
Tomograpic_viewer(matrix_3D_corrected/matrix_3D_corrected.max(),False,1,s) # here you can enable the logaritmic scale
